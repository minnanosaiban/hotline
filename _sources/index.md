...
参考：<a href="https://minnanosaiban.github.io/hotline/2021Judgment.html#handan1">リンク <i class="fa-solid fa-link"></i> </a>の先のオレンジの部分が判決文の該当箇所です。
</blockquote>
</div>
...
<p class="q" style="margin-top: 1.6em; ">
参考：<a href="https://minnanosaiban.github.io/hotline/2021Judgment.html#handan2">リンク <i class="fa-solid fa-link"></i> </a>の先のオレンジの部分が判決文の該当箇所です。
</blockquote>
</div>

<p class="base" style="margin-top: 1.6em; ">
原告は、通報内容に関して上司が嘘をついていると感じていましたが、嘘であると断定することはできませんでした。相手方が定めたコンプライアンスホットライン規程は、「調査とは、通報情報に関する事実を確認するための調査」と定めています。
<p class="base" style="margin-top: 1.6em; ">
...
<p class="base" style="margin-top: 1.6em; ">
調査補助者とは、通報対応業務を行う担当者です。「公益通報者保護法に基づく指針の解説」<a href="https://minnanosaiban.github.io/hotline/law.html#kaisetsu">リンク <i class="fa-solid fa-link"></i></a> の内容からすると裁判所の判断は誤っているように思います。

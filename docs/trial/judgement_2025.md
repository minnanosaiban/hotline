...
<b>理由１</b>　契約書の問題を指摘する通報は、そもそも無かった<br>
<b>理由２</b>　「海外消費税を支払う合意」をしていたと推認できる
</p>
...
<summary>判決文抜粋）理由１の該当箇所</summary>
...
<details class="card-accordion width-40" markdown>
<summary>判決文抜粋）理由２の該当箇所</summary>
<div class="accordion-body" markdown>
...
**特徴３　会社側の行動には理由が付き、通報者側の行動は量で語られる**

認定事実を読み比べると、会社側の対応は、理由とセットで書かれています。

> 一般に、ＧＳＴの還付は納税者の「権利」であり「義務」ではなく、**したがって**、ＧＳＴの還付をするか否かは任意であり……

一方、通報者側の行動は、量を示す言葉で書かれています。

> ……など**３０項目**に分けて整理したパワーポイント資料を作成し……

理由つきで書かれた側は筋の通った対応に見え、量だけ書かれた側は過剰に見えます。ただ、この「３０項目」が何だったのかは、判決自身が記録しています（[認定事実キ <i class="bi bi-arrow-up-right"></i>](#2025-kousai-judgment_ninteiki)）。第一に、判決はこの資料を「**『通報情報に関する事実』を……整理したパワーポイント資料**」と呼んでいます。量の言葉で語られた資料の、判決自身による定義は、通報の対象事実の整理です。第二に、作成に至る順序も同じ認定事実に記録されています。法務２グループが調査対象を是正措置の完了や隠蔽・圧迫の有無の確認として整理し、通報者が調査を求めた疑問点とずれたまま往復が続いた末の、「**最終的に、自ら**」でした。第三に、中身は判決がＮｏ．１・Ｎｏ．２・Ｎｏ．１０として引用しており、日付と行為を特定した事実の主張であることを確認できます。会社自身も、この３０項目について「**いずれも不正行為等に該当しない**」という調査結果を示しました（[認定事実ク <i class="bi bi-arrow-up-right"></i>](#2025-kousai-judgment_nintei-ku)）——一つずつ調査して答えられる形の資料だった、ということです。そして認定事実は、この資料の引用のすぐ後に「法務２グループは……関係者へのヒアリングを実施するなどの調査をした」と続けています。調査に対象を与えたのは、ほかならぬこの資料でした。

**特徴４　通報者の行動が、受け取る側の視点で語られている**

「繰り返し送信するなどし」「**自ら**……作成し……送付するなどした」。動詞はすべて、受け取る法務グループの側から、届いたもの・負担として書かれています。同じ行為を作り手の側から書けば、「調査を求める事実を、調査できる形に整理して渡した」——判決自身がこの資料に与えた説明（『通報情報に関する事実』を「整理した」資料）と同じ内容です。「自ら」の一語は、会社側の整理が定まらないやり取りの中で作られた資料に、「頼まれてもいないのに」という響きを加えています。

...
<p class="width-40 margin02">
理由１・理由２は、いずれも法令等に違反する事実自体がなかったという構成になっており、控訴審で先鋭化された通知義務の要否という争点は、その前提を欠くとして実質的に検討されないまま終わっています。しかも、この２つの理由を導く事実解釈そのものにも無理があります。以下、判決文を確認します。
</p>

<details class="card-accordion width-40" markdown>
<summary>理由１の判決文を読む</summary>
<div class="accordion-body" markdown>

高裁は、①「通報」の意味をまず定義し、②契約書の問題を指摘する主張が明確になったのは令和元年１２月だとした上で、通知義務違反を否定しています。
...
しかし、高裁自身が認定した事実（認定事実ウ）には、上記と符合しない記載があります。**本件通報（平成２８年９月１４日）の約４か月後、平成２９年１月４日の時点で、契約書の作成方法についてすでに触れられているのです。**
...
<details class="card-accordion width-40" markdown>
<summary>理由２の判決文を読む</summary>
<div class="accordion-body" markdown>

高裁は、①契約書に定めがなくても合意で決まるという一般論、②平成２９年４月まで支払いが続いていたこと、③平成３０年契約で初めて「課さない」条項が加わったこと、の3点から、平成２７年契約の締結時にＧＳＴを支払う合意があったと推認しています。
...
判決が言及する「契約書に定めがなくても合意で決まる」という一般原則自体は成り立ちます。しかし、**同じ理屈がそのまま海外消費税にも及ぶのかは考えにくいです。**
...
<details class="card-accordion width-40" markdown>
<summary>「認定事実」に現れない経緯を書証で確認する</summary>
<div class="accordion-body" markdown>

判決の「認定事実」は、証拠の中から裁判所が選んで記載したものであり、証拠そのものではありません。以下は、認定事実には現れていない、あるいは十分には現れていないものの、書証で確認できる経緯です。

- 引用中の太字は引用者による強調

**契約書の論点は、本件通報より前から、社内で問題提起されていました。** 原告は本件通報（平成２８年９月１４日）に先立つ同年１月７日、上司への相談で契約時のＧＳＴ除外について疑問を伝えています。同年９月１０日には「豪州子会社が還付を受けたので対応不要」と説明されましたが、この説明は半年後（平成２９年３月）に誤りだったと判明しています。

> ２０１６／９／１０　豪州子会社が還付請求を行い還付を受け、その還付金は豪州子会社の収益として計上されたため、入金処理等、ＪＸＥが会計処理として行うことは、何も無いと伝えられた。（本件事業部の担当者さんより）
> ↑翌年１７年３月に、実際には、還付が受けられていなかったことが判明した
>
> —— [甲１７（平成２８年１月〜２９年３月の経緯）<i class="bi bi-arrow-up-right"></i>](https://minnanosaiban.github.io/eneos-saiban/_static/甲17_税務処理の確認経緯_ENEOS_公開.pdf)

判決の認定事実自体にも、この点への留保が記録されています。平成２８年１２月２８日、被告の経理部は、還付の制度上の適法性と、実際に還付処理をしたかどうかを、そもそも別の話として回答していました。

> ①被控訴人はＪＸＡとグルーピング登録を行っていることから、被控訴人が納付した付加価値税について、ＪＸＡが還付を受けることは問題なく……**②ＪＸＡが還付処理をしているか自体が不明である場合は、貴部からＪＸＡに問い合わせるか、別途相談してもらいたい**……
>
> —— 判決認定事実イ（平成２８年１２月２８日、甲１２・乙１０）

つまり、「還付を受けた」かどうかは、会社の経理部自身が当初から把握していませんでした。その後の本件メール（甲２０の１）は「還付請求を実施し……戻入れも実施済み」と述べていますが、これも社内報告であり、豪州当局の還付通知など外部の裏付けは記録のどこにも見当たりません。

**原告は、業務の移管を境に、契約に関する情報から遠ざけられました。** この点は、被告自身が訴訟の準備書面で認めています。

> 原告のいう「本件調査対応協議」が実施されたこと、原告のいう「ＧＳＴ業務移管通知」がなされたこと、**ＧＳＴ業務移管通知に基づく業務移管によって、原告は被告と本件豪州企業の間で締結した契約に関する情報から遮断された状態になったこと**は、それぞれ認める……
>
> —— [被告準備書面（２）における認否 <i class="bi bi-arrow-up-right"></i>](/hotline/trial/eneos/#hikoku2_214)

後に判決が前提とする「契約内容は会社にしか確認できない」という状態は、この業務移管によって作られたものです。

**令和元年１２月２０日、会社は契約書の確認を明示的に拒否しました。**

> 当社と本件豪州企業間の契約書について確認するように再三お求めですが、これを行う必要はないものと判断しています。なぜならば、そもそも、その取引に税金が課されるか否かについては、民間同士の合意である契約書ではなく、国（本件豪州企業との取引であればオーストラリア国家）が決めることです。
>
> —— [甲２５の５（令和元年１２月２０日）<i class="bi bi-arrow-up-right"></i>](https://minnanosaiban.github.io/eneos-saiban/_static/甲25_調査補助者とのメール_ENEOS_公開.pdf#page=5)

なお、この回答は税務アドバイザーへの相談を理由に挙げていますが、相談先・時期・内容のいずれも記録上示されておらず、会社の説明以外に裏付けはありません。

**令和２年１月２３日、会社は追加調査の打ち切りを通知しました。**

> 業務上の裁量に属する行為の当否について、法務部がさらに調査しても、調査結果である「コンプライアンス違反ではない」との結論に変更はなく、これ以上調査する必要を認めないとの判断に至りましたので、その旨ご連絡申し上げます。
>
> —— [甲２５の８（令和２年１月２３日）<i class="bi bi-arrow-up-right"></i>](https://minnanosaiban.github.io/eneos-saiban/_static/甲25_調査補助者とのメール_ENEOS_公開.pdf#page=9)

**通常の通報窓口では進展がなく、令和２年３月２７日、原告は社長が読む社内ＳＮＳ「社長・大田さんの輪」に投稿しました。**

> 本投稿は、コンプライアンスホットライン制度の責任者の大田さんに、お伝え申し上げるものです。……制度の利用では、解決が図れませんでしたので、失礼ながらではございますが、投稿にてお伝え申し上げます。
>
> —— [甲２６の１（令和２年３月２７日）<i class="bi bi-arrow-up-right"></i>](https://minnanosaiban.github.io/eneos-saiban/_static/甲26_本件SNS投稿_ENEOS_公開.pdf)

**約３か月後の令和２年６月２５日、この投稿への回答という形で、契約内容が初めて示されました。**

> ６月２４日までに原告さんが社長ＳＮＳ「大田さんの輪」に投稿した内容につき……今回改めて原告さんが社長ＳＮＳ上でご指摘になった契約書についても入手し調査しましたので、下表のＮｏ．３にてその結果もお知らせします。
>
> —— [甲２１の１（令和２年６月２５日）<i class="bi bi-arrow-up-right"></i>](https://minnanosaiban.github.io/eneos-saiban/_static/甲21_本件契約の説明_ENEOS_公開.pdf)

判決５５１行目は「被控訴人は……令和２年６月までにその点の事実調査をし、その結果を控訴人に伝えている」と述べています。事実として誤りではありませんが、この一文は、２度にわたる確認拒否・調査打ち切りと、社内ＳＮＳへの投稿を経て初めて動いたという経緯を圧縮したものです。

</div>
</details>

<details class="card-accordion width-40" markdown>
<summary>会社の通知文書の言い回しを書証で確認する</summary>
<div class="accordion-body" markdown>

会社が通報者に出した調査報告（甲１９）と、是正の内容が記載された社内報告メール（甲２０）には、言い回しに共通する特徴があります。**後から「そういう意味ではなかった」と説明し直せる余地が、あらかじめ残されている**ことです。

- 引用中の太字は引用者による強調

**調査報告（平成２９年８月１４日）**は、調査結果を次の一文で報告しています。

> 本件は、税務上もコンプライアンス違反となる事項ではない旨を経理部と確認済みであり、さらに、経理部およびコンサルティング会社と相談し、業務を本件事業部業務グループに移管した上で、**還付可能であることを確認している**付加価値税の還付を含め、今年度上期を**目途**に対応完了**予定であることを確認した**。
>
> —— [甲１９の１（本件調査報告）<i class="bi bi-arrow-up-right"></i>](https://minnanosaiban.github.io/eneos-saiban/_static/甲19_本件調査報告1_ENEOS_公開.pdf)

この一文には、限定が三つ重ねられています。

- 還付の対象は、「還付可能であることを確認している」分に絞られています。還付されない金額が後で出てきても、この文とは矛盾しません。
- 「目途」「予定」は、期限の約束ではありません。
- 文末は「〜予定であることを確認した」です。報告されているのは、対応が完了したことではなく、予定があるということだけです。

つまり、この後たとえ何も実行されなくても、この文は誤りにはなりません。また、冒頭の「経理部と確認済み」は、経理部の実際の回答に付いていた「還付処理をしているか自体が不明」という留保（前のアコーディオンで引用した認定事実イ）を落とした要約です。

同じ報告書は、対応を「是正」ではなく**「業務改善」**と呼び、個別の質問には次のように回答しています。

> コンプライアンスホットライン相談は「不正行為等の有無」を確認するものであるところ、**本件は既にコンプライアンス違反では無いことが確認されているため**、制度の趣旨と異なることから、具体的な個別の事項については、回答を差し控えさせていただきます。

結論（違反ではない）を理由に、その結論を検証するための個別の事実への回答を断る、という構造です。

**社内報告メール（平成２９年１０月１６日）**は、還付の顛末を次のように報告しています。

> 過去分のＧＳＴ還付請求について　過年度ＪＸＴＧエネルギーの支払分については豪州子会社にて１７年９月までに**還付請求を実施**。また豪州子会社への**還付額**について、ＪＸＴＧエネルギーへの**戻入れも実施済み**。
>
> —— [甲２０の１（本件部長報告）<i class="bi bi-arrow-up-right"></i>](https://minnanosaiban.github.io/eneos-saiban/_static/甲20_本件部長報告_ENEOS_公開.pdf)

言い切られているのは、社内で完結する事実（請求をした・送金した・帳簿に載せた）だけです。肝心の「豪州当局から実際に還付を受けた」という事実は、どの文でも主張されていません。「還付額」という言葉が使われているため、還付があったことは当然の前提のように読めますが、それを事実として述べた文は、このメールのどこにもありません。このメールにはほかにも、次の特徴があります。

- メール全体が「本件」としか言わず、**通報にもホットラインにも一度も触れていません**。被告は後の訴訟で、このメールを「本件通報に関する正式な通知ではない」と位置づけています。
- 「**２０１６年１１月以降ＧＳＴの法改正により**……確認済み」――「以降」の後に助詞がなく、法改正の時期も内容もこの一文からは特定できません。後の訴訟で原告が特定を求めた際にも、被告は「回答する必要を認めない」として答えていません（理由２のアコーディオン参照）。
- 過払い分の返金を「**精算**」と表現――被告は訴訟でも「精算済み」の方が適切な表現だと正面から争っています。

これらの言い回しは、読み手の深読みではありません。**その多くが、後の訴訟で被告側の整理として実際に使われています**。また、調査報告で「対応完了予定」と留保されていた内容は、２年後の追加調査報告（令和元年１０月）では「還付を受け、対応を完了している」という断定に変わりましたが、その間に外部の裏付けが加わった形跡は記録上ありません。しかもこの断定も、原文は「**還付を受けられる**すべての金額について平成２９年９月までに還付を受け」であり、仮に還付されていない金額があっても「それは受けられない金額だった」と説明できる形が保たれています。

言い切りの形と、何が主張されているかは、別のものです。ここに挙げた文は、いずれも断定の口調で書かれていますが、断定されている中身を確かめると、「確認した」「相談した」という行為の存在だけだったり、「還付可能な分」「還付を受けられる金額」という自己限定つきの範囲だったりします。見分け方は簡単です。**「知りたいことの答えがノーでも、この文は正しいままか」**と問うてみてください。正しいままなら、その文は、知りたいことについて何も述べていません。たとえば「還付を受けられるすべての金額について還付を受けた」は、１円も還付されていなくても正しいままの文です。
...
認定事実の中では、「〜と回答した」という発言の記録と、「〜であった」という事実の記録が、同じ調子で並びます。たとえば判決には、会社が「税務アドバイザーを起用して検討を行った」と回答した、という記述があります。ここで認定されているのは「そう回答した」ことだけで、相談が実際にあったことではありません（相談先・時期・内容は、記録のどこにも出てきません）。それでも読み手は、「経理部と確認済み」「専門家に相談済み」という文から、書かれていない中身を「問題ないと確認されたのだろう」と自分で補って読み進めます。AIでの検証では、経理部の回答に付いていた「還付処理をしているか自体が不明」という留保が、要約の過程で消えました。
...
判決は「被控訴人は……令和２年６月までにその点の事実調査をし、その結果を控訴人に伝えている」と書きます。事実として誤りではありませんが、この一文には、２度の確認拒否と調査打ち切り、社内ＳＮＳへの投稿を経てようやく調査に至った半年の経緯（「認定事実に現れない経緯」のアコーディオン参照）が畳み込まれています。圧縮された文だけを読むと、会社の対応は自然で速やかに見えます。

**特徴３　会社側の行動には理由が付き、通報者側の行動は量だけが書かれている**

認定事実を読み比べると、会社側の対応は、理由とセットで書かれています。

> 一般に、ＧＳＴの還付は納税者の「権利」であり「義務」ではなく、**したがって**、ＧＳＴの還付をするか否かは任意であり……

一方、通報者側の行動は、理由がないまま、量だけが書かれています。

> ……など**３０項目**に分けて整理したパワーポイント資料を作成し……

理由つきで書かれた側は筋の通った対応に見え、量だけ書かれた側は過剰に見えます。しかし、この３０項目の資料は、約２年分・複数の論点にわたる経緯を時系列・問題別に整理した、事実確認のための資料です。１か月あたりに直せば１〜２項目です。しかも認定事実は、「通報情報に関する事実」の中身を、この資料の項目（Ｎｏ．１・Ｎｏ．２・Ｎｏ．１０）を引用して示した上で、すぐ後に「法務２グループは……関係者へのヒアリングを実施するなどの調査をした」と続けています。つまり、調査に対象を与えたのは、ほかならぬこの資料でした。

**特徴４　通報者の行動が、受け取る側の視点で語られている**

「繰り返し送信するなどし」「**自ら**……作成し……送付するなどした」。動詞はすべて、受け取る法務グループの側から、届いたもの・負担として書かれています。同じ行為を作り手の側から書けば、「面談で説明するために資料を準備した」です。「自ら」の一語は、会社側の整理が定まらないやり取りの中で作られた資料に、「頼まれてもいないのに」という響きを加えています。
...
組み立て方も毎回同じです。実在する規程の文言（通報とは、不正行為等を**是正する目的で**内容を告げる行為、という定義）を引用し、「会社はすでに是正を済ませた」と宣言し――この宣言に裏付けがないこと、そして会社の調査が答えたのは「還付」という別の話題だったことは、上の２つのアコーディオンで見たとおりです――、「是正が済んだ後も続く追及は通報の目的から外れる」という判決文にない理屈を立て、最後に通報者の行動と心理を「送りつけた」「強硬手段」「正義感が強固になっていた」という言葉で語り直します。要は「是正を済ませた」という宣言で、そこが崩れると、物語全体が根拠を失います。

なお、これは判決を書いた裁判官の意図の問題ではありません。判決文はもともと、記録の全体を手元に持つ当事者と上級審に向けて書かれる文書で、結論に必要な事実だけを選んで載せます。その同じ文書を、記録を持たない読み手——記者、一般の読者、AI——が単独で読むと、選ばれた事実が「話の全部」になります。このページが判決文に書証を添えているのは、判決への反論のためではなく、判決文が本来想定していた「記録を知っている読み手」の条件を、一般の読み手のために復元するためです。

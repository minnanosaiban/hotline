...
<p class="width-40 margin02">
理由１・理由２は、いずれも法令等に違反する事実自体がなかったという構成になっており、控訴審で先鋭化された通知義務の要否という争点は、その前提を欠くとして実質的に検討されないまま終わっています。この２つの理由を導く事実解釈は、判決自身が認定した事実と突き合わせて確認できます。以下、判決文を確認します。
</p>
...
<details class="card-accordion width-40" markdown>
<summary>経緯の全体をタイムラインで確認する</summary>
<div class="accordion-body" markdown>

判決の「認定事実」は、証拠の中から裁判所が結論に必要な範囲で選んで記載するもので、証拠そのものではありません。以下は本件の経緯の全体です。判決の認定事実に記録されている出来事と、判決には現れないものの書証や訴訟記録で確認できる出来事を、区別した上で同じ時系列に並べています。各項目から、判決文の該当箇所と書証（ＰＤＦ）を直接確認できます。

<p class="tl-legend"><span class="tl-key"></span>判決の認定事実に記録された出来事　<span class="tl-key tl-key-out"></span>判決には現れない出来事（書証・訴訟記録で確認）</p>
...
なお、「還付を受けた」ことについて、豪州当局の還付通知のような会社の外側からの裏づけは、認定事実にも書証にも現れていません。

</div>
</details>

<details class="card-accordion width-40" markdown>
<summary>会社が通報者に説明しなかったのは何か</summary>
<div class="accordion-body" markdown>

**還付を実際に受けたのかどうか。根拠とされた「法改正」はどの法律のことか。「確認した」の中身は何か。**——会社が通報者に出した調査報告（甲１９）と、是正の内容が記載された社内報告メール（甲２０）は断定の口調で書かれていますが、これらを述べた文は一つもありません。それを可能にしているのが、言い回しに共通する特徴です。**後から「そういう意味ではなかった」と説明し直せる余地が、あらかじめ残されている**のです。
...
つまり、この後たとえ何も実行されなくても、この文は誤りにはなりません。また、冒頭の「経理部と確認済み」は、経理部の実際の回答に付いていた「還付処理をしているか自体が不明」という留保（[認定事実イ <i class="bi bi-arrow-up-right"></i>](#2025-kousai-judgment_nintei-i)）を落とした要約です。
...
- 「**２０１６年１１月以降ＧＳＴの法改正により**……確認済み」――「以降」の後に助詞がなく、法改正の時期も内容もこの一文からは特定できません。後の訴訟で原告が特定を求めた際にも、被告は「回答する必要を認めない」として答えていません（[被告準備書面（５） <i class="bi bi-arrow-up-right"></i>](/hotline/trial/eneos/#hikoku5_342)）。
...
組み立て方も毎回同じです。実在する規程の文言（通報とは、不正行為等を**是正する目的で**内容を告げる行為、という定義）を引用し、「会社はすでに是正を済ませた」と宣言し、「是正が済んだ後も続く追及は通報の目的から外れる」という判決文にない理屈を立て、最後に通報者の行動と心理を「送りつけた」「強硬手段」「正義感が強固になっていた」という言葉で語り直します。要は「是正を済ませた」という宣言がすべての土台で、そこが崩れると、物語全体が根拠を失います。

その土台は、判決文の中で確かめられます。判決が引用する会社の報告は、「**還付可能であることを確認している**」ＧＳＴの還付（[前提事実⑶ <i class="bi bi-arrow-up-right"></i>](#2025-tisai-judgment_zentei-3)）、「**還付を受けられる**全ての金額について……還付を受け対応を完了している」（[認定事実ク <i class="bi bi-arrow-up-right"></i>](#2025-kousai-judgment_nintei-ku)）という自己限定の形で書かれています。還付されない金額が残っていたとしても、正しいままの文です。そして、豪州当局の還付通知のような、会社の外側からの裏づけは、記録上どこにも現れていません。会社の調査が本件通報の対象を「還付」と捉えていたこと――通報者が問題にしていた契約書とは別の話題――も、判決自身が認定しています（[認定事実イ <i class="bi bi-arrow-up-right"></i>](#2025-kousai-judgment_nintei-i)）。

...
<span class="q-chip">[判決文｜認定事実ケ <i class="bi bi-arrow-up-right"></i>](#2025-kousai-judgment_nintei-ke)</span>

……そのために税務アドバイザーを起用して検討を行ったことは対応として誤りではない……**などと回答する**とともに……
</div>

<div class="q-card" markdown>
<span class="q-chip">この判決文だけを読ませたＡＩの出力</span>
...
複数のAIが独立に、判決文のどこにも書かれていない同じ物語にたどり着きました。

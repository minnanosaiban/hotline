...
一文に限定が三重に入っています。還付の対象は「可能と確認できた分」に絞られ、「目途」「予定」は約束ではなく見込みであり、文末が「予定であることを確認した」なので、報告されているのは完了ではなく「予定の存在」です。仮に何も完了しなくても、この文は誤りになりません。また「経理部と確認済み」の部分は、経理部の実際の回答に付いていた「還付処理をしているか自体が不明」という留保（認定事実イ）を落としています。
...
言い切られているのは、社内で完結する事実（請求をした・送金した・帳簿に載せた）だけです。肝心の「豪州当局から実際に還付を受けた」ことは、独立した文としては一度も主張されず、「還付額」という言葉の中に前提として埋め込まれています。このメールにはほかにも、次の特徴があります。
...
これらの言い回しは、読み手の深読みではありません。**その多くが、後の訴訟で被告側の整理として実際に使われています**。また、調査報告で「対応完了予定」と留保されていた内容は、２年後の追加調査報告（令和元年１０月）では「平成２９年９月までに還付を受け、対応を完了している」という断定に変わりましたが、その間に外部の裏付けが加わった形跡は記録上ありません。
...
物語は、おおよそ次の手順で組み上がります。

1. 実在する規程の文言（通報とは、不正行為等を**是正する目的で**内容を告げる行為、という定義）を引用する。
2. 「会社はすでに是正を済ませた」と宣言する。――この前提は、上の２つのアコーディオンで見たとおり、会社の説明以外に裏付けがありません。また、会社の調査が答えたのは「還付」という広い話題であり、通報者が問題にした「契約書に定めのない上乗せ払い」という論点そのものではありません。
3. ２を前提に、「これ以降の追及は通報の目的から外れる」という、判決文のどこにもない理屈を立てる。
4. 通報者のその後の行動を「送りつけた」「強硬手段」といった言葉で語り直し、判決文に書かれていない心理（「正義感が強固になっていた」等）まで補って、人物像を完成させる。

土台は２です。ここが崩れると、３・４の「通報者への否定的な評価」は根拠を失います。

**なぜこの読み方になるのか。** 一つは、文章の形の違いです。会社側は「経理部と確認済み」「専門家と相談済み」という言い切りの文章を書けますが、通報者側は、会社にしか確認できない事実を尋ねる立場なので、「まだ分からない」「確認してほしい」という形の文章しか書けません。読み手は、この形の違いを中身の信頼性の差として受け取りがちです。

もう一つは、判決文の記述の非対称です。認定事実は、会社側の対応には理由を付して記載し（「還付は義務ではなく権利であり、**したがって**……」）、通報者側の行動は理由なしに数量だけで記載します（「……など**３０項目**に分けて整理したパワーポイント資料を作成し」）。理由が書かれた側は合理的に見え、数量だけの側は過剰に見えます。なお、この３０項目の資料は、約２年分の経緯を時系列・問題別に整理した、事実確認のための資料です。認定事実自身、この記載の直後に「法務２グループは……関係者へのヒアリングを実施するなどの調査をした」と続けており、資料が実際の調査の土台になったことを示しています。

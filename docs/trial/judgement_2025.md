...
<details class="card-accordion width-40" markdown>
<summary>AIも誤解する６つの事項</summary>
<div class="accordion-body" markdown>

この判決文をAIに読ませて要約させると、繰り返し同じ誤解が生じることを確認しています。実際に複数のセッションでAIに検証させた結果、特に誤りやすかったのは次の６点です。

1. **「対象を特定した」の具体例が一つも示されないまま、基準として通用してしまう**：判決は「除外される事項」しか書いておらず、「これなら通報として認められる」という例は判決文のどこにもありません。AIは、この基準を一応妥当な規範として受け取りがちです。

2. **会社が２回出した調査結果を、そのまま「争点に答えた」と読んでしまう**：会社が調査したのは「ＧＳＴの還付」という広い話題であり、通報者が本当に問題にしていた「契約書に定めのない上乗せ払い」という狭い論点とは対象が違います。AIは、何について結論を出したかという主語を混同しやすいところです。

3. **「認定事実」を証拠そのものだと思い込む**：認定事実は、証拠の中から裁判所が選んで書いたものです。契約書の論点が通報の数か月後には調査担当者に伝わっていたこと、会社が２度確認を拒否し社長への社内投稿を経てようやく動いたことなど、認定事実には現れない経緯があります。AIは認定事実だけを読んで経緯を要約しがちです。

4. **「合意で決まる」という一般論を、そのまま海外消費税にも当てはめてしまう**：契約当事者の合意で決まるのは私的な費用負担の話であり、外国の税法上の納税義務の有無とは次元が異なります。AIは一般論の正しさに引きずられて、対象が違うことに気づきにくい傾向があります。

5. **高裁の判決を、地裁の判断を補強したものだと読んでしまう**：高裁は地裁の理由（法的な利益がない）を全面的に書き改め、理由１・理由２という、地裁も、勝訴した会社自身も一度も主張していない独自の理論に差し替えています。AIは「上級審が下級審を追認した」という自然な構図に引きずられがちです。

6. **確認する手段のない側に、事実の特定を求める基準を中立だと思ってしまう**：契約書を確認できるのは会社だけで、通報者にはその手段がありません。それにもかかわらず判決は通報者に対象の特定を求めています。消費者庁の指針や会社自身の規程とも一致しない基準です。

実際にAIにこの判決文を読ませて、上記の点を指摘できるか試してみてください。

...
<details class="card-accordion width-40" markdown>
<summary>判決文だけを読むと、どんな物語ができるか（AIでの検証）</summary>
<div class="accordion-body" markdown>

この判決文だけをAIに読ませて要約させる検証を、系統の異なる複数のAI（Claude・NotebookLM）で繰り返し行いました。共通して現れたのは、個別の読み間違いにとどまらず、**「執念深い通報者」対「合理的に対応した会社」という、判決文のどこにも書かれていない物語**が出来上がることです。

AIは、この事件への先入観も、どちらかに味方する事情も持っていません。その複数のAIが、互いに知らないまま同じ物語にたどり着くということは、これが読み手ごとの偏りではなく、**判決文の書き方そのものが生む読み方**だということを示しています。

物語は、おおよそ次の順で組み上がります。

1. まず、実在する規程の文言を引用します。通報とは、不正行為等を**是正する目的で**内容を告げる行為である、という定義です。ここまでは正確です。
2. 次に、「会社はすでに是正を済ませた」と宣言します。この宣言に裏付けがないことは、上の２つのアコーディオンで見たとおりです。そもそも会社の調査が答えたのは「還付」という別の話題で、通報者が問題にした「契約書に定めのない上乗せ払い」ではありません。
3. この宣言を土台に、「是正が済んだ後も続く追及は、通報の目的から外れている」という理屈を立てます。この理屈は、判決文のどこにも書かれていません。
4. 最後に、この理屈に沿って通報者の行動を語り直します。資料の提出は「送りつけた」になり、社内での相談は「強硬手段」になり、判決文にない心理（「正義感が強固になっていた」）まで補われて、人物像が完成します。

要は２番目の宣言です。「是正を済ませた」が崩れると、その上に立つ理屈も人物像も、根拠を失います。

**なぜこの読み方になるのか。** 「経理部と確認済み」という文を読むと、経理部が「問題ない」と確認したように聞こえます。しかし、この文が実際に述べているのは、確認という行為があったことだけです。**何を確認したのか、経理部の答えが何だったのかは、書かれていません。** 読み手は、書かれていない部分を「問題なかったのだろう」と自分で補って、読み進めてしまいます。

通報者の側から見ると、同じ文がまったく違って見えます。知りたいこと――契約書に何と書いてあるのか、還付は本当に受けたのか――は、依然として書かれていないままだからです。だから尋ね直すしかありません。こうして、**答えの入っていない回答が質問を繰り返させ、繰り返された質問が「説明を受けたのに納得しない人」という印象を作ります。** 読み手が感じる「執念」は、通報者の性格からではなく、回答の空白から生まれています。

もう一つの理由は、判決文自身の書き方にあります。認定事実を読み比べると、会社側の対応は、理由とセットで書かれています。
...
理由つきで書かれた側は筋の通った対応に見え、量だけ書かれた側は過剰に見えます。しかし、この３０項目の資料は、約２年分の経緯を時系列・問題別に整理した、事実確認のための資料です。認定事実自身も、この記載のすぐ後に「法務２グループは……関係者へのヒアリングを実施するなどの調査をした」と続けており、資料が実際の調査の土台として使われたことが分かります。

つまりこれは、AIの欠陥の記録ではなく、この判決文が初見の読み手をどこへ運ぶかの記録です。同じ材料を短時間で読めば、人間の読者にも同じことが起こり得ます。実際にお使いのAIにこの判決文を読ませて、次の点を確かめてみてください。

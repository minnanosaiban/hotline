...
![ウィンドウ別サマリ](img/09_car_event_study/02_window_summary.png){width="1200"}これは「**発表直後 1 週間で投資家の利食いが入り、その後ドリフト本体が出る**」というクラシックな PEAD パターンに合致します。勝率も同じく [-1,+5] で 48.7% と一時的に 50% を割ります。
...
連載 01〜08 で下した評価が、本記事の CAR で実際に裏付けられたかを一覧にしました。

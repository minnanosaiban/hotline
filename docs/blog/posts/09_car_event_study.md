...
「良い決算なら株価は上がる」 ― 本当にそうでしょうか。**決算の中身が良いこと**と、**それが実際に市場で買われること**は、まったく別の問題です。

決算分析の多くは **「決算データの中身」**（割安度・利益の質・成長性）を評価します。本記事は視点を逆転し、決算発表後に市場がどう反応したか ― 超過リターン（CAR）― を **市場全体の決算でまとめて** 測定します。学術的に **PEAD（Post-Earnings-Announcement Drift）** ― 発表後にサプライズの方向へ株価がドリフトし続けるアノマリー ― が、自前で集めたデータでも観測できるかを検証します。

...
# GARP で「成長と割安の両立銘柄」を発掘する ― PEG × ROE の理論と実践
...
**GARP 理想ゾーンのコスモは −6.5% で唯一の下落**、ROE が劣る ＥＮＥＯＳ は +28.3%、出光は +23.2% と上昇しています。
...
- 石油元売 3 社では **コスモ（GARP 理想）が −6.5%、ＥＮＥＯＳ が +28.3%** と GARP と株価が逆転

...
### 数値スコアだけでは見えない「利益の質」レンズ

連載04〜05 の数値スコアは「利益の量と水準」を見るものでした。しかし連載03 で見た ＥＮＥＯＳ 2022 ピークのように、**実績が良い決算でも「利益の中身が良いか」は別問題**です。純利益は会計処理である程度動かせますが、営業キャッシュフローは動かしにくい ― この差（アクルーアル）が利益の質を映します。

| レンズ | 何を見るか | 限界 |
|---|---|---|
| 連載04-05 数値スコア | PEG / ROE / 7 ファクター | 利益の「量」と「水準」止まり |
| **連載06 アクルーアル** | **純利益と営業 CF の乖離** | **利益の "質" まで踏み込む** |

...
# セグメント発進力スコアで「次の主力事業」を発掘する ― 決算短信のセグメント情報
...
- ソニーグループの 6 セグメントで **音楽事業の営業利益率 21.4%** が突出 ― マルチファクター総合スコア 44 では見えない「軽資産で永続キャッシュ」ビジネスの収益性
- **加速 Top1: 大東建託 不動産開発 +185.5%**、**丸紅 次世代事業 +127%**、**双日 エネルギー・ヘルスケア +79%** など、新規・周辺事業の本格寄与シグナル
- **減速 Worst: セブン&アイ スーパーストア −47.4%（売上 6,876 億）** ― 大規模事業再編の影響が企業合算ではなく **セグメントレベルで初めて可視化**
- **高営業利益率 Top: マキタ アジア 88.4% / アドバンテスト テストシステム 50.9%（売上 1.02 兆円）/ 東海旅客鉄道 運輸業 46.7%** ― 業界寡占構造の定量化
- ここまでは銘柄横断の **発掘・スクリーニング**。セグメント発進力スコアは「次の主力事業」と「隠れた高収益事業」を企業合算では見えない解像度で炙り出す

...
<p class="fig-meta">データ出典<br>番外編A と同じ 5 分足・流動性上位 300 銘柄（2025-11-21〜2026-05-29）。学習 111 万バー（〜2026-03-31）→ 検証 51 万バー（2026-04-01〜、境界 1 日はパージ）。実装は `blog21_scalping_ml.py`</p>
...
<p class="fig-meta">使用データ<br>5分足（流動性上位300銘柄、2025-11-21〜2026-05-29、検証51万バー）</p>

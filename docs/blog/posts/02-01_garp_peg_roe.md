...
<p class="fig-meta">使用データ: PEG・ROE＝証券会社アプリのアナリストコンセンサス（PER予想・前期EPS=2026年3月期実績→予想EPS=2027年3月期コンセンサスの成長率）／PER算出の株価＝yfinance（2026年5月末時点）</p>
...
<p class="fig-meta"><i class="fa-solid fa-expand"></i> クリックで拡大</p>
<p class="fig-meta">使用データ: 株価＝yfinance 日足終値（直近6ヶ月、2026年5月末時点）／騰落率は期間始点比</p>

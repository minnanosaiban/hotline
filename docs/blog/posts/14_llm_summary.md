...
要約のキーワード「**営業利益 +339.8%（継続事業ベース）・急回復**」はポジティブ。CAR も +1.36% と小幅プラスで、**短期市場は要約とほぼ一致した反応**。連載15 の類似群比較でも +3.34pp 上回り（連載15 でいう「ポジショック」）、**「数字パターン上の急回復を市場が好感」した銘柄** に位置づけられます。

なお、**在庫影響除き営業利益相当額 4,744 億円** は 2025/3 期業績予想修正発表時の主張「実質営業利益 4,400 億維持」を上回って着地しており、連載01 4 基準試算と整合。連載10 で見た 3 年累積 CF/純利 = 114% の **回収局面到来** とも整合し、連載13 の 2025-03-28 業績予想修正発表（CAR -13.89%）に対する **後年の reverse パターン** として読めます。
...
| **ＥＮＥＯＳ** | ポジ（営業利益急回復・自己株活用・在庫影響除き 4,744 億で主張通り着地） | +1.36% | **一致（ポジ × ポジ）**。連載10 累積 CF 回収局面・連載13 2025-03-28 反応の reverse とも整合 |
...
- 主要 3 銘柄の LLM 要約と 2026/3 期 CAR を並べると、**「要約と市場反応が一致する銘柄」と「乖離する銘柄」が両方ある**:
    ...
    - **ＥＮＥＯＳ CAR [−1, +1] = +1.36%**：要約は「営業利益 +339.8% (継続事業ベース) 急回復」とポジで市場反応と一致。在庫影響除き営業利益相当額 4,744 億で 2025/3 期業績予想修正時の主張「実質 4,400 億維持」を上回って着地、連載10 の 3 年累積 CF/純利 = 114% の回収局面と整合

...
時価総額などを参考に、東証上場から 1,500 銘柄を選び、PEG × ROE 平面（GARP マップ）にプロットしました。

![GARP マップ 主要銘柄](img/01_PEG_ROE/01_garp_map.png){width="1200"}

緑が **GARP 理想ゾーン**（PEG ≤ 1.0 かつ ROE ≥ 10%）です。

背景の水色ドットは **業種代表 51 銘柄** ― 各業種から時価総額トップを機械的に選び、石油元売 3 社・任天堂・ソフトバンクＧ・ＫＤＤＩ・三井住友ＦＧなど、読み手が知っている大型株を補強したユニバースです。

そのうち **日経 225 主要銘柄 15 社をラベル付きで強調** しました。理想ゾーン（左上）に入っているのは **三井住友だけ**。多くは PEG 1.0〜1.5 の中庸ゾーンに集まり、「割安とは言い切れないが、極端な割高でもない」水準です。

**割安 × 高 ROE の両立は、大型株ではいかに稀か** ― チャートはそれを一目で示しています。
...
<div class="margin01">
<div class="card-bule">
<p class="small"><b>📝 PEG・ROE が捉えきれない構造要因</b></p>
...
<div class="margin01">
<div class="card-bule">
<p class="small"><b>📊 編集部試算: 4 つの修正率基準</b></p>

...
<p class="fig-meta">データ出典: 自前で構築したパイプラインの `data/statements/*_FY.json` 841 件（actual） + 327 件（forecast）から (code) マッチ 327 ペアを構築し、`data/rakunav/213_EPS.csv` を結合した 211 銘柄サンプル</p>

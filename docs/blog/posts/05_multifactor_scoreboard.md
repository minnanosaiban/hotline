...
# マルチファクターで「全方位優等生銘柄」を発見する ― 7 ファクター・スコアボードで採点
...
- ＥＮＥＯＳ は Growth 54 / Consensus 22 で **過去実績と先行き予想がズレる構造**（詳細は[GARP の記事](04_garp_peg_roe.md)の 4 基準試算）

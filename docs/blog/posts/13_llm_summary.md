...
- 主要 3 銘柄の LLM 要約と 2026/3 期 CAR を並べると、**「要約と市場反応が一致する銘柄」と「乖離する銘柄」が両方ある**:
    ...
    - **ＥＮＥＯＳ CAR [−1, +1] = +1.36%**：要約は「営業利益 +339.8% (継続事業ベース) 急回復」とポジで市場反応と一致。在庫影響除き営業利益相当額 4,744 億で 2025/3 期業績予想修正時の主張「実質 4,400 億維持」を上回って着地、連載09 の 3 年累積 CF/純利 = 114% の回収局面と整合

...
![LLM要約](img/14_llm/00_thumbnail.png){width="1280"}
...
![パイプライン全体](img/14_llm/01_pipeline_overview.png){width="1200"}
...
![プロンプト構造](img/14_llm/02_prompt_structure.png){width="1200"}
...
![モデル別コスト比較](img/14_llm/03_cost_comparison.png){width="1200"}
...
![丸紅 vs 双日 サンプル出力](img/14_llm/04_sample_outputs.png){width="1200"}
...
![要約とCARの接続](img/14_llm/05_car_overlay.png){width="1200"}

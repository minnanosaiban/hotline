...
![パイプライン全体](img/16_prediction/01_pipeline.png){width="950"}
...
![予測 vs 実績](img/16_prediction/02_pred_vs_actual.png){width="950"}
...
![K の感度分析](img/16_prediction/04_K_sensitivity.png){width="950"}
...
![個別ショック Top-10](img/16_prediction/03_shocks_top10.png){width="950"}
...
![戦略フロー](img/16_prediction/05_strategy_flow.png){width="950"}

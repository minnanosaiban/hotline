...
ただし、連載06 で示した **有報 XBRL の 7 期時系列** からは間接的な類推が可能です。ＥＮＥＯＳ は 2022 年純利益 5,371 億円（ROE 20.7%）から 2025 年 2,261 億円（ROE 7.1%）へと **3 年で縮小**。一方 ENEOS自身は構造要因（のれん減損・在庫影響）を理由に「**実質営業利益 4,400 億円水準は維持**」と主張しています（[連載06](06_XBRLとは何か.md) 構造要因解説、[連載01](01_PEG_ROE銘柄分析.md) 4 基準試算参照）。
